...
import app.android.mmauri.seccion_04_realm.adapters.BoardAdapter;
...
public class BoardActivity extends AppCompatActivity implements RealmChangeListener<RealmResults<Board>>, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* DB Realm */
        realm = Realm.getDefaultInstance(); // Ya lo tenemos configurado en MyApplication
        boards = realm.where(Board.class).findAll();
        /* Creamos el metodo que se activara siempre que haya cambios en "boards" y lo vinculamos */
        ...
        /* Creamos el metodo que se activara siempre que se clique en un item de listview, y lo vinculamos */
    ...
    private void showAlertForEditingBoard(String title, String message, final Board board) {
        ...
        /* Insertamos el boton "Save", y configuramos su comportamiento */
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        /* Necesitamos el "info" para recuperar la posicion del board seleccionado */
